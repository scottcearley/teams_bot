...
export interface ISusdHelpDeskFaqpConnectorConfigState extends ITeamsBaseComponentState {
...
export interface ISusdHelpDeskFaqpConnectorConfigProps extends ITeamsBaseComponentProps {
}
...
/**
 * Implementation of the susdHelpDeskFaqpConnector Connector connect page
 */
export class SusdHelpDeskFaqpConnectorConfig extends TeamsBaseComponent<ISusdHelpDeskFaqpConnectorConfigProps, ISusdHelpDeskFaqpConnectorConfigState> {
        ...
        if (this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.HOSTNAME}/susdHelpDeskFaqpConnector/config.html`,
