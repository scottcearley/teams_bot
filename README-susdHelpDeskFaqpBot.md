# SUSDHelpDeskFAQP Bot - `susdHelpDeskFaqpBot`
...
3. Give the bot a handle (ex: `susdHelpDeskFaqpBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://faqp.azurewebsites.net/api/messages`
